...
faqs:
  - question: "What are the odds Khamenei leaves power by February 28?"
    answer: "Prediction markets currently show 99.9% odds that Khamenei will be out as Iran's Supreme Leader by February 28, based on over $85 million in total trading volume. However, these extreme odds may reflect headline-driven momentum rather than realistic probability of such a rapid transition."
  - question: "How much money is being bet on Khamenei losing power?"
    answer: "Over $85 million in total volume has been wagered on this market, with $62.8 million traded in just the last 24 hours. This massive volume spike suggests either whale activity or coordinated belief that something significant has happened behind the scenes."
  - question: "Why are prediction markets so confident about Khamenei's exit?"
    answer: "The extreme confidence (99.9% odds) likely stems from the recent US-Israeli strikes on Iran, reported casualties including 148 dead at a school, and speculation about Khamenei's health or the regime's stability. However, odds this extreme may overestimate the probability of such a rapid leadership transition given Iran's government structure."
  - question: "Is betting NO on Khamenei leaving worth the risk?"
    answer: "At 0.1% odds for NO, you'd risk $1 to potentially win $999, but you'd need near-perfect accuracy since Khamenei has held power for 35+ years and Iranian government transitions require formal processes. The risk/reward is extremely unfavorable unless you have specific information suggesting the market has badly overreacted to current headlines."
---
...
When you see odds this extreme on [Polymarket](https://polymarket.us/1762?utm_source=masterpredictionmarkets&utm_medium=blog&utm_campaign=signup), your first instinct should be skepticism. A 99.9% probability means traders think there's basically zero chance Khamenei stays in power through February 28.
...
Understanding [implied probability](/blog/how-to-calculate-implied-probability-prediction-markets) is critical here. At 99.9%, you'd need to risk $999 to win $1 if you bet YES. That's an insane risk/reward ratio unless you have insider information or you're hedging some other position.
...
The challenge with [finding edge](/blog/prediction-market-strategies-finding-edge-as-a-retail-trader) in markets this lopsided is you're betting against consensus with extreme conviction. You need to either know something the market doesn't, or believe the market is emotionally overreacting to headlines without considering practical realities of Iranian power structures.

## How to Think About This Trade

This isn't a market for beginners or anyone looking to learn [what are prediction markets](/blog/what-are-prediction-markets). The risk/reward is too skewed and the information asymmetry too high.
