...
howToSteps:
  - name: "Export your Polymarket transaction history"
    text: "Download your full trade history from your Polymarket account or pull wallet transactions from Polygonscan. Record every buy, sell, and settlement with dates, amounts, and USDC values."
  - name: "Calculate cost basis for each position"
    text: "Your cost basis is the USDC you paid for shares plus any gas fees. If you bought 100 YES shares at $0.35 each, your cost basis is $35.00 plus gas."
  - name: "Determine gains and losses on each trade"
    text: "For settled contracts: gain = settlement payout minus cost basis. For sold positions: gain = sale proceeds minus cost basis. Track both winners and losers."
  - name: "Report on your tax return"
    text: "Report crypto prediction market gains on Schedule D and Form 8949. Each trade is a separate line item with date acquired, date sold/settled, proceeds, cost basis, and gain or loss."
  - name: "Keep records for at least 3 years"
    text: "The IRS can audit returns up to 3 years back (6 years if they suspect underreporting). Store your transaction exports, wallet records, and cost basis calculations."
faqs:
  - question: "Does Polymarket report to the IRS?"
    answer: "No. Polymarket doesn't issue 1099 forms or report your trading activity to the IRS. But you're still legally required to report all gains and losses on your tax return. The IRS has been increasingly focused on crypto-related income."
  - question: "How are Polymarket profits taxed?"
    answer: "Polymarket gains are most likely taxed as short-term capital gains at your ordinary income tax rate, since most contracts settle within days or weeks. Unlike Kalshi, Polymarket contracts don't qualify for Section 1256 (60/40) treatment because Polymarket isn't a CFTC-regulated exchange."
  - question: "Can I deduct Polymarket losses on my taxes?"
    answer: "Yes. Polymarket trading losses can offset capital gains from other investments. If your net capital losses exceed gains, you can deduct up to $3,000 per year against ordinary income, with the rest carrying forward to future tax years."
  - question: "Do I need to pay taxes on Polymarket if I didn't receive a 1099?"
    answer: "Yes. No 1099 doesn't mean no tax obligation. The IRS requires you to report all income regardless of whether the platform sends tax forms. Failing to report crypto gains carries penalties including fines and interest."
---
...
When you trade on [Kalshi](/blog/kalshi-review), you get a 1099-B at the end of the year showing every trade, your cost basis, and your gains. The IRS gets a copy too. It's straightforward — the numbers match, you report them, done.
...
|---|---|---|
| Tax treatment | 60% long-term / 40% short-term | 100% short-term |
| $10,000 gain at 32% bracket | ~$2,300 | ~$3,200 |
| 1099 issued | Yes | No |
| Cost basis calculated | By exchange | By you |
...
| | [Kalshi](/blog/kalshi-tax-reporting) | [Polymarket](/blog/polymarket-guide-how-to-trade-crypto-prediction-markets) |
|---|---|---|
| 1099 issued | Yes (1099-B) | No |
| Reports to IRS | Yes | No |
| Tax classification | Potentially Section 1256 (60/40) | Short-term capital gains |
| Cost basis tracking | Done by exchange | Done by you |
| Fee deduction | Automatic in 1099 | Manual tracking required |
| Loss carryback | 3 years (if Section 1256) | No carryback |
| Ease of filing | Straightforward | Requires crypto tax tools |

For pure tax efficiency, Kalshi's the better platform. But Polymarket offers [different markets, higher liquidity on some events, and no trading fees](/blog/kalshi-vs-polymarket-which-platform-should-you-use), so plenty of traders use both. If you do, keep separate records for each and report everything together.
...
The smart play: use a dedicated wallet, track every trade, run your transactions through crypto tax software, and talk to a CPA if your activity is substantial. The traders who treat their [prediction market activity](/blog/what-are-prediction-markets) as a legitimate financial endeavor — including the unglamorous tax part — are the ones who don't get blindsided by the IRS.
