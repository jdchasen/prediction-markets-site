...
faqs:
  - question: "What are the current odds that Khamenei will be removed as Supreme Leader?"
    answer: "Prediction markets are pricing Khamenei's removal by February 28 at 99.9% probability, with over $103 million traded on this outcome. This essentially means traders believe his ouster is virtually certain."
  - question: "How much money has been bet on Khamenei's removal?"
    answer: "Over $103 million in total volume has been traded on this market, with $19.8 million traded in just the last 24 hours alone, making it one of the most-wagered geopolitical events in prediction market history."
  - question: "Can you still make money betting YES at 99.9% odds?"
    answer: "At 99.9% odds, betting YES means you'd pay 99.9 cents for a contract worth $1 if it resolves YES, netting only 0.1 cent profit per share. The potential returns are minimal because the market has already priced in near-certainty."
  - question: "Why would anyone bet NO when odds are at 99.9%?"
    answer: "Betting NO at 0.1% odds offers a 1,000x return if Khamenei remains in power through February 28, but it requires the market and all current reporting about Iran to be fundamentally wrong. It's an extreme long-shot bet with massive upside but minimal probability of success."
---
...
When you see [Polymarket](https://polymarket.us/1762?utm_source=masterpredictionmarkets&utm_medium=blog&utm_campaign=signup) odds at 99.9%, the market isn't really predicting anymore — it's reacting to information that suggests the outcome is effectively decided. Either Khamenei's already gone and we're waiting for official confirmation, or something so definitive has occurred that traders consider his removal inevitable by the February 28 deadline.
...
Why would anyone buy YES at 99.9%? A few possibilities: people locking in tiny guaranteed returns (assuming they're certain), traders closing out NO positions they're stuck in, or capital flowing in from people who just heard the news and want exposure to what they see as a sure thing. Understanding [implied probability](/blog/how-to-calculate-implied-probability-prediction-markets) helps clarify what these percentages actually mean for real-world outcomes.
...
This is where [finding edge](/blog/prediction-market-strategies-finding-edge-as-a-retail-trader) becomes critical. Edge in prediction markets comes from having better information or better analysis than the crowd. At 99.9%, the crowd is saying "we know something definitive." Betting against that without insider knowledge is just gambling on a miracle.
...
The February 28 deadline is what's known as a resolution date — the cutoff for when the market settles. Markets like this trade on [Kalshi](https://kalshi.com/sign-up/?referral=f2e21ad4-75b7-4ffb-bfcc-f2fb36e07b21&m=true&utm_source=masterpredictionmarkets&utm_medium=blog&utm_campaign=signup) with clear resolution criteria, though this specific market appears to be running on crypto-based platforms.

## The Smart Play

If you're looking at this market now, you're not finding value — you're either witnessing history or getting a lesson in [common mistakes](/blog/5-common-prediction-market-mistakes-to-avoid) like chasing odds that have already moved.
