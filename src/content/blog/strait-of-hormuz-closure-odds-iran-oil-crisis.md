...
faqs:
  - question: "What are the odds Iran closes the Strait of Hormuz?"
    answer: "Polymarket shows 57% odds Iran closes the Strait of Hormuz by March 31, 2026, with $5.67M in volume. Longer-dated markets show 65% by June 30 and 68% by December 31. Kalshi prices the same event lower at 29% by May 2026."
  - question: "What happens if the Strait of Hormuz closes?"
    answer: "The Strait of Hormuz handles roughly 20% of the world's oil supply—about 21 million barrels per day. Closure would likely push oil above $100/barrel and potentially to $140+, triggering fuel price spikes, airline cost increases, and potential recession risks in import-dependent economies."
  - question: "Why are Polymarket and Kalshi odds so different on Hormuz?"
    answer: "Polymarket shows 57% odds of Hormuz closure by March 31 while Kalshi shows only 29% by May 2026. The gap likely reflects different trader bases (crypto-native vs US retail), different resolution criteria, and Polymarket's faster reaction to breaking news. This spread may represent an arbitrage opportunity."
  - question: "How much money is being bet on the Strait of Hormuz closing?"
    answer: "Total volume across all Hormuz-related markets on Polymarket exceeds $7.2 million. Combined with Kalshi markets, tens of millions have been wagered on whether Iran disrupts the world's most important oil chokepoint."
---

The Strait of Hormuz just became the most expensive prediction market bet in the world. As oil spikes 13% to $82/barrel and gold tests $5,400, traders on [Polymarket](https://polymarket.us/1762?utm_source=masterpredictionmarkets&utm_medium=blog&utm_campaign=signup) are pricing in 57% odds that Iran closes the strait by March 31—a chokepoint that handles 21 million barrels of oil per day, roughly 20% of global supply. That's better than even-money odds on an economic catastrophe.
...
Everyone's watching the [Iran regime collapse markets](/blog/will-khamenei-lose-power-market-shows-999-odds) at 18% (March 31) and 48% (end of 2026). But the Hormuz market is the one that affects your wallet tomorrow morning. Here's why:
...
That's a 28-point spread between Polymarket's March number (57%) and Kalshi's May number (29%). Even accounting for different timeframes, this gap is enormous. Either Polymarket traders are panic-buying on headlines, or Kalshi traders are asleep at the wheel. For more on how to exploit these cross-platform gaps, see our [prediction market arbitrage guide](/blog/prediction-market-arbitrage-guide).

The spread likely reflects three things:

1. **Different trader bases** — Polymarket's crypto-native crowd reacts faster to breaking news; Kalshi's regulated US retail traders are more cautious
2. **Resolution criteria** — "close" vs "disrupt" vs "restrict" may mean different things on each platform
3. **Liquidity dynamics** — Polymarket has 10x the volume here, which usually means more accurate pricing
...
When ceasefire odds are at 7% for the next four days, that means traders are nearly certain the conflict escalates before it de-escalates. Every day without a ceasefire is another day Iran might play its trump card. The [ceasefire market](https://polymarket.us/1762?utm_source=masterpredictionmarkets&utm_medium=blog&utm_campaign=signup) has done $7 million in total volume—this is where serious money is expressing its view.
...
Here's a sidebar worth noting: [Kalshi](/blog/kalshi-review) has paused payouts on the Khamenei market ($54 million in volume) while reviewing whether it violates their policy against profiting from death. CBS News called it "insider trading in broad daylight," and a senator has raised concerns.

This matters for Hormuz traders because it signals regulatory risk. If Kalshi pauses more Iran-related markets, the platform gap widens further and Polymarket becomes the only venue for real-time geopolitical price discovery. For context on platform differences, see our [Kalshi vs Polymarket comparison](/blog/kalshi-vs-polymarket-which-platform-should-you-use).
